...
public class EditarDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.editarMascota(masco,nombreMasco,raza,color,observaciones,alergico,ateEsp,nombredueno,celDueno);
        
        mostrarMensaje("Edicion realizada correctamente", "Info", "Edicion correcta");
        
        VerDatos cd = new VerDatos();
        cd.setVisible(true);
    ...
    private void cargarDatos(int num_cliente) {
        ...
        txtCelDueno.setText(masco.getDueno().getCelular());
